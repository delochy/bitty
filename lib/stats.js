 ...
 *  24차: 작업이 진짜 끝났는지 판정하는 데도 쓴다 (lib/state.js settleCodexPending). */
...
module.exports = { appendActivity, dayStats, mascot, todayKey, gameTotals, todayTokens, liveTokens, codexTokensUsed, ITEMS, QUESTS };
