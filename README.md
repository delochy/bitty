...
<p align="center"><img src="docs/widget.png" width="300" alt="Idle Buddy 마스코트 위젯: 작업이 길어지고 있어요, 카테고리 탭과 추천 퀘스트 캐러셀"></p>
...
**Codex 사용자**: Codex는 새 훅을 처음 한 번 **승인(신뢰)** 해야 실행해요. Codex를 열었을 때 나오는 안내나 `/hooks`에서 승인해 주세요.
...
- **Codex 연결은 아직 실제 작업으로 검증되지 않았어요.** 가짜 훅 신호로만 확인했어요. 안 되면 이슈로 알려주세요.
